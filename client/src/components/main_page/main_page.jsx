...
const { IS_LOGGED_IN, CURRENT_USER, FETCH_USER } = Queries;
                  ...
                  return (
                    <Query query={CURRENT_USER}>
                      ...
                      const currentUserId = data.currentUserId;
                        return <Query query={FETCH_USER} variables={{ id: currentUserId }}>
                        {( data ) => {
                          const name = data.data;
                          return <div className="main-page-container">
                            <MainNav className="main-page-nav" currentUserId={currentUserId} name={name}/>
                            <Switch>
